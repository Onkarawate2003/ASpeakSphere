...
export type ConversationContextValue = {
    ...
    // ------------------------------------------------------------------
    // Phase 1 — AI Session Review fields
    // ------------------------------------------------------------------

    /** Overall score 0–100 generated by the AI coach. Null until available. */
    overallScore: number | null;
    /** Narrative coach feedback paragraph. Null until available. */
    coachFeedback: string | null;
    /** Bullet-list of identified strengths. Null until available. */
    strengths: string[] | null;
    /** Bullet-list of areas to improve. Null until available. */
    areasForImprovement: string[] | null;
    /** Single concrete next-step recommendation. Null until available. */
    nextRecommendation: string | null;
    /**
     * True while the frontend is polling the backend for an async AI summary
     * that has not yet been written. Consumers use this to show a loading
     * skeleton inside the AI Session Review card.
     */
...
export type ConversationResponseDTO = {
    ...
    // Phase 1 Summary Enhancement — populated from conversation_performance when ready.
    /** Overall AI score 0–100. Null while the background task is still running. */
    overall_score: number | null;
    /** Narrative coach feedback. Null while the background task is still running. */
    coach_feedback: string | null;
    /** Identified strengths list. Null while the background task is still running. */
    strengths: string[] | null;
    /** Areas for improvement list. Null while the background task is still running. */
    areas_for_improvement: string[] | null;
    /** Next-step recommendation. Null while the background task is still running. */
